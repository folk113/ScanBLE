...
import com.phubber.ble.common.PermissionHelper;
import com.phubber.ble.common.PermissionInterface;
import com.phubber.ble.iBeaconClass.iBeacon;
...
public class DeviceScanActivity extends ListActivity implements PermissionInterface {
	...
	// 读写BLE终端
	static private BleService mBLE;
...
//		getActionBar().setTitle("正在扫描设备 ....");
	 ...
	 * 搜索到BLE终端服务的事�?
	 */
	private BleService.OnServiceDiscoverListener mOnServiceDiscover = new BleService.OnServiceDiscoverListener() {
	 ...
	 * 收到BLE终端数据交互的事�?
	 */
	private BleService.OnDataAvailableListener mOnDataAvailable = new BleService.OnDataAvailableListener() {
		/**
		 * BLE终端数据被读的事�?
		 */
		@Override
		public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
			...
			Log.e(TAG, "onCharRead " + gatt.getDevice().getName() + " read " + characteristic.getUuid().toString()
		...
		public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
			Log.e(TAG, "onCharWrite " + gatt.getDevice().getName() + " write " + characteristic.getUuid().toString()
